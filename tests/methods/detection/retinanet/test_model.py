...
def test_model_sketch_list(retina_sketch_fixture, tensor_image_fixture):
...
def test_model_sketch_dict(retina_sketch_fixture, tensor_image_fixture):
    model = retina_sketch_fixture
    image = tensor_image_fixture
    model.eval()
    results = model(image)
...
def test_model_sketch_boxes(retina_sketch_fixture, tensor_image_fixture):
    model = retina_sketch_fixture
    image = tensor_image_fixture
    model.eval()
    results = model(image)
...
def test_model_sketch_scores(retina_sketch_fixture, tensor_image_fixture):
    model = retina_sketch_fixture
    image = tensor_image_fixture
    model.eval()
    results = model(image)
...
def test_model_sketch_labels(retina_sketch_fixture, tensor_image_fixture):
    model = retina_sketch_fixture
    image = tensor_image_fixture
    model.eval()
    results = model(image)
