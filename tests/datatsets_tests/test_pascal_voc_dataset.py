...
from vespa.datasets.pascalVOC.pascal_voc_transforms import (
...
def pascal_voc_dataset(create_pascal_voc_dataset):
    """
    Cria uma instância do PascalVOCDataset usando a
    fixture create_pascal_voc_dataset.
    """
...
def test_pascal_voc_dataset_boxes(create_pascal_voc_dataset):
    """
    Testa se as caixas delimitadoras no
    PascalVOCDataset são carregadas corretamente.
    """
    root_dir = create_pascal_voc_dataset
    dataset = PascalVOCDataset(root_dir=root_dir, transforms=None)
    _, target = dataset[0]
...
def test_pascal_voc_train_transforms_image_shape(create_pascal_voc_dataset):
    """
    Testa se as transformações de treino no
    Pascal VOC geram imagens com 3 dimensões.
    """
    root_dir = create_pascal_voc_dataset
...
def test_pascal_voc_test_transforms_no_bboxes(create_pascal_voc_dataset):
    """
    Testa se as transformações de teste no
    Pascal VOC não processam bounding boxes.
    """
    root_dir = create_pascal_voc_dataset
    dataset = PascalVOCDataset(
        root_dir=root_dir,
