...
from utils.distortions import PROJECT_ROOT
...
class KADIS700Dataset(Dataset):
    ...
    def __getitem__(self, index: int) -> dict:
        ...
        return {"img_A_orig": img_A_orig, "img_A_ds": img_A_ds, "img_B_orig": img_B_orig, "img_B_ds": img_B_ds,
                "img_A_name": img_A_name, "img_B_name": img_B_name, "distortion_functions": distort_functions,
                "distortion_values": distort_values}
